export const translations = {
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { id: 2, name: "Fasting Lunch & Dinner", desc: "A vibrant spread of plant-based Ethiopian classics — lentils, chickpea stews, and roasted vegetables." },
  ...
  am: {
    ...
    hero: {
      ...
      tagline: "ጥሩ ምግብ • ላይቭ ባንድ • የላውንጅ ተሞክሮ",
      button: "ያስሱ",
      reserve: "ቦታ ያስይዙ",
      scroll: "ወደ ታች",
    },
    ...
    services: {
      ...
      items: [
        ...
        { id: 2, name: "የጾም ምሳ እና እራት", desc: "ምስር፣ ሽሮ፣ አትክልት እና እንጀራ የተካተቱበት ባህላዊ የጾም ምግቦች ስብስብ።" },
        { id: 7, name: "ልዩ ፉል", desc: "በወይራ ዘይት፣ ሽንኩርት እና ቲማቲም የተዘጋጀ ምርጥ ፉል በቃሪያ የታጀበ።" },
        { id: 8, name: "ካቴሎ", desc: "በምርጥ የኢትዮጵያ ቅመሞች የተጠበሰ ልዩ የስጋ መክሰስ።" },
        { id: 3, name: "ፍቅር", desc: "ዱለት፣ ቋንጣ፣ እንቁላል፣ ጎመን እና አይብ — ለ2 ሰዎች።" },
        { id: 4, name: "አንድነት", desc: "ጥብስ፣ ሰንበር፣ ቋንጣ፣ ዱለት፣ ጎመን፣ አይብ፣ እንቁላል እና ስጋ ፍርፍር — ለ-3 ሰዎች።" },
